...
[MerchantNumber] NVARCHAR(15)  NOT NULL,/*This field displays the number that identifies the Merchant*/
...
[PanNumber] NVARCHAR(19) NOT NULL,/*This field displays the Card number or Voucher used in the transaction (this should be masked)*/
...
[AuthorizationID] NVARCHAR(6) Null,/*This field displays the Authorisation Id from the Authorizer*/
...
[AdditionalData] NVARCHAR(MAX)  NULL, /*This field displays additional information carried in the transaction.*/
